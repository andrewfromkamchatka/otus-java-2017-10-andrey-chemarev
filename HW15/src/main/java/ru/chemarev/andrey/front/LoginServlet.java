...
public class LoginServlet extends HttpServlet {
    ...
    private String getPage(String login, String message, String contextPath) throws IOException {
        Map<String, Object> pageVariables = new HashMap<>();
        pageVariables.put("login", login == null ? "" : login);
        pageVariables.put("message", message == null ? "" : message);
        pageVariables.put("contextPath", contextPath);
        return TemplateProcessor.instance().getPage(LOGIN_PAGE_TEMPLATE, pageVariables);
    }

    @Override
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.getWriter().println(getPage(null, null, request.getContextPath()));
    }
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.getWriter().println(getPage(requestLogin, message, request.getContextPath()));
    }
